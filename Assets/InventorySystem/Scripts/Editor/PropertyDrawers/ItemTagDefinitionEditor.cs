...
namespace Nexora.InventorySystem.Editor
{
    ...
    public class ItemTagDefinitionEditor : DefinitionEditor<ItemTagDefinition>
    {
        ...
        public override void DrawCustomInspector()
        {
            ...
            _showFoldout = EditorGUILayout.BeginFoldoutHeaderGroup(_showFoldout, "Tag Used by Items");
        ...
        {
            var itemTagDefinition = (ItemTagDefinition)target;
            _linkedItems ??= ItemDefinitionUtility.GetAllItemsWithTag(itemTagDefinition);
